          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(child: Text("enter your detailes here",style: TextStyle(color: Colors.yellow,fontSize: 35,fontWeight: FontWeight.bold),)),
                ...
                child:Center(child: Text("submit",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.red),)) ,
                    ),
                  ),
                ),
              ],
