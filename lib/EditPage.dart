...
class EditPage extends StatefulWidget {
  ...
  final String mobileno;
   ...
   EditPage({Key? key, required this.name, required this.place, required this.mobileno, required this.email, required this.id}) : super(key: key);
                  ...
                  child: InkWell(
                    onTap: (){
                      showDialog(
                        ...
                        return AlertDialog(
                          title:Text( "detailes Added Successfully"),
                          actions: [
                    ...
                    child: Container(
                      ...
                      child:Center(child: Text("Update",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.red),)) ,
                    ),
                  ),
                ),
              ],
